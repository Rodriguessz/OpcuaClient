...
const ReverseHelloMessage_1 = require("./ReverseHelloMessage");
...
class ServerTCP_transport extends tcp_transport_1.TCP_transport {
     ...
     */
    initReverse(socket, reverseHello, callback) {
        // c8 ignore next
        debugLog?.(chalk_1.default.cyan("initReverse socket"));
        (0, node_opcua_assert_1.assert)(!this._socket, "init already called!");
        const reverseHelloMessage = new ReverseHelloMessage_1.ReverseHelloMessage({
        ...
        try {
            ...
            (0, ReverseHelloMessage_1.validateReverseHelloFields)(reverseHelloMessage);
        }
        catch (err) {
        ...
        this._install_socket(socket);
        // c8 ignore next
        utils_1.doTraceHelloAck && warningLog(`sending ReverseHello\n${reverseHelloMessage.toString()}`);
        // send the ReverseHello, then reuse the exact same HEL receiver as a normal inbound connection.
        const messageChunk = (0, tools_1.packTcpMessage)("RHE", reverseHelloMessage);
