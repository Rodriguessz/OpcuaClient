...
function getCrypto() {
    ...
    if (!c || typeof c.getRandomValues !== "function") {
        throw new Error("[NODE-OPCUA] no cryptographically secure random source available: " +
...
function cryptoRandomBytes(size) {
    const buffer = (0, node_opcua_buffer_utils_1.createFastUninitializedBuffer)(size);
...
//# sourceMappingURL=crypto_random.js.map