...
class ServerSecureChannelLayer extends node_events_1.EventEmitter {
    ...
    init(socket, callback) {
        ...
        this.#transport.init(socket, (err) => this.#_onTransportInitialized(err, callback));
    ...
    initReverse(socket, reverseHello, callback) {
        this.#_prepareTransportTimeout();
        this.#transport.initReverse(socket, reverseHello, (err) => this.#_onTransportInitialized(err, callback));
        this.#_installTransportCloseListener();
    }
    #_prepareTransportTimeout() {
    ...
    #_installTransportCloseListener() {
    ...
    #_onTransportInitialized(err, callback) {
