 ...
 */
function convertUserAccessLevel(userAccessLevel, accessLevel) {
    if (userAccessLevel === undefined || userAccessLevel === null || userAccessLevel === "") {
        return accessLevel;
    }
    return convertAccessLevel(userAccessLevel);
}
function convertAccessRestrictions(accessRestrictions) {
    ...
    return (0, node_opcua_data_model_1.makeAccessRestrictionsFlag)(value);
}
...
function makeNodeSetParserEngine(addressSpace, options) {
     ...
     */
    function convertNodePermissions(attrs) {
        return {
            ...
            rolePermissions: applyRolePermissions && (0, node_opcua_basic_types_1.coerceBoolean)(attrs.HasNoPermissions) ? [] : undefined
        };
    }
