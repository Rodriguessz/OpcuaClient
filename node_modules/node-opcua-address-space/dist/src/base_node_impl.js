 ...
 */
function install_child_as_object_property(parentObj, child) {
...
function install_components_as_object_properties(parentObj) {
    ...
    for (const reference of hierarchicalRefs) {
        install_child_as_object_property(parentObj, reference_impl_1.ReferenceImpl.resolveReferenceNode(addressSpace, reference));
    }
}
