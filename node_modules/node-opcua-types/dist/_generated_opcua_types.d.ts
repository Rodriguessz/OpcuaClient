 ...
 */
import { Byte, ByteString, DateTime, Double, Float, Guid, Int16, Int32, Int64, SByte, UABoolean, UAString, UInt16, UInt32, UInt64 } from "node-opcua-basic-types";
import { Enum, EnumItemLike } from "node-opcua-enum";
...
export interface AliasCategoryUpdateDataTypeOptions {
    category?: PortableNodeIdOptions;
    lastChange?: UInt32;
}
export declare class AliasCategoryUpdateDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    lastChange: UInt32;
    constructor(options?: AliasCategoryUpdateDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export interface AliasNameVerboseDataTypeOptions {
    aliasName?: (QualifiedNameLike | null);
    referencedNodes?: ExpandedNodeId[] | null;
    serverUris?: UAString[] | null;
    aliasNameCategoryId?: (NodeIdLike | null);
}
export declare class AliasNameVerboseDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    constructor(options?: AliasNameVerboseDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface AliasUpdateDataTypeOptions {
    applicationUri?: UAString;
    categories?: AliasCategoryUpdateDataTypeOptions[] | null;
}
export declare class AliasUpdateDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    static encodingDefaultJson: ExpandedNodeId;
    applicationUri: UAString;
    categories: AliasCategoryUpdateDataType[] | null;
    constructor(options?: AliasUpdateDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export interface BaseConfigurationDataTypeOptions {
    configurationVersion?: UInt32;
    configurationProperties?: KeyValuePairOptions[] | null;
}
export declare class BaseConfigurationDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    constructor(options?: BaseConfigurationDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface BaseConfigurationRecordDataTypeOptions {
    name?: UAString;
    recordProperties?: KeyValuePairOptions[] | null;
}
export declare class BaseConfigurationRecordDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    constructor(options?: BaseConfigurationRecordDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export interface ApplicationIdentityDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
    applicationUri?: UAString;
    applicationNames?: (LocalizedTextLike | null)[] | null;
    additionalServers?: ApplicationDescriptionOptions[] | null;
}
export declare class ApplicationIdentityDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    static encodingDefaultJson: ExpandedNodeId;
    applicationUri: UAString;
    applicationNames: LocalizedText[] | null;
    additionalServers: ApplicationDescription[] | null;
    constructor(options?: ApplicationIdentityDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export declare enum TrustListValidationOptions {
    None = 0,
...
export declare const _enumerationTrustListValidationOptions: Enum;
export interface CertificateGroupDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
    purpose?: (NodeIdLike | null);
    certificateTypes?: (NodeIdLike | null)[] | null;
    isCertificateAssigned?: UABoolean[] | null;
    validationOptions?: TrustListValidationOptions;
}
export declare class CertificateGroupDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    static encodingDefaultJson: ExpandedNodeId;
    purpose: NodeId;
    certificateTypes: NodeId[] | null;
    isCertificateAssigned: UABoolean[] | null;
    validationOptions: TrustListValidationOptions;
    constructor(options?: CertificateGroupDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    setValidationOptions(value: any): TrustListValidationOptions;
    get schema(): IStructuredTypeSchema;
}
export interface EndpointDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
    discoveryUrls?: UAString[] | null;
    networkName?: UAString;
    port?: UInt16;
}
export declare class EndpointDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    networkName: UAString;
    port: UInt16;
    constructor(options?: EndpointDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface ServerEndpointDataTypeOptions extends EndpointDataTypeOptions {
    recordProperties?: KeyValuePairOptions[] | null;
    endpointUrls?: UAString[] | null;
    securitySettingNames?: UAString[] | null;
    transportProfileUri?: UAString;
    userTokenSettingNames?: UAString[] | null;
    reverseConnectUrls?: UAString[] | null;
}
export declare class ServerEndpointDataType extends EndpointDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    userTokenSettingNames: UAString[] | null;
    reverseConnectUrls: UAString[] | null;
    constructor(options?: ServerEndpointDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export interface SecuritySettingsDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
    securityModes?: MessageSecurityMode[] | null;
    securityPolicyUris?: UAString[] | null;
    certificateGroupName?: UAString;
}
export declare class SecuritySettingsDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    securityPolicyUris: UAString[] | null;
    certificateGroupName: UAString;
    constructor(options?: SecuritySettingsDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    setSecurityModes(value: EnumItemLike[] | null | undefined): MessageSecurityMode[] | null;
    get schema(): IStructuredTypeSchema;
}
...
export interface UserTokenSettingsDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
...
export declare class UserTokenSettingsDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    certificateGroupName: UAString;
    authorizationServiceName: UAString;
    constructor(options?: UserTokenSettingsDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    setTokenType(value: any): UserTokenType;
    get schema(): IStructuredTypeSchema;
}
export interface ServiceCertificateDataTypeOptions {
    certificate?: ByteString;
    issuers?: ByteString[] | null;
    validFrom?: DateTime;
    validTo?: DateTime;
}
export declare class ServiceCertificateDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    validFrom: DateTime;
    validTo: DateTime;
    constructor(options?: ServiceCertificateDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface AuthorizationServiceConfigurationDataTypeOptions extends BaseConfigurationRecordDataTypeOptions {
    serviceUri?: UAString;
    serviceCertificates?: ServiceCertificateDataTypeOptions[] | null;
    issuerEndpointSettings?: UAString;
}
export declare class AuthorizationServiceConfigurationDataType extends BaseConfigurationRecordDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    static encodingDefaultJson: ExpandedNodeId;
    serviceUri: UAString;
    serviceCertificates: ServiceCertificateDataType[] | null;
    issuerEndpointSettings: UAString;
    constructor(options?: AuthorizationServiceConfigurationDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface ApplicationConfigurationDataTypeOptions extends BaseConfigurationDataTypeOptions {
    applicationIdentity?: ApplicationIdentityDataTypeOptions;
    certificateGroups?: CertificateGroupDataTypeOptions[] | null;
    serverEndpoints?: ServerEndpointDataTypeOptions[] | null;
    clientEndpoints?: EndpointDataTypeOptions[] | null;
    securitySettings?: SecuritySettingsDataTypeOptions[] | null;
    userTokenSettings?: UserTokenSettingsDataTypeOptions[] | null;
    authorizationServices?: AuthorizationServiceConfigurationDataTypeOptions[] | null;
}
export declare class ApplicationConfigurationDataType extends BaseConfigurationDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    certificateGroups: CertificateGroupDataType[] | null;
    serverEndpoints: ServerEndpointDataType[] | null;
    clientEndpoints: EndpointDataType[] | null;
    securitySettings: SecuritySettingsDataType[] | null;
    userTokenSettings: UserTokenSettingsDataType[] | null;
    authorizationServices: AuthorizationServiceConfigurationDataType[] | null;
    constructor(options?: ApplicationConfigurationDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export declare enum ConfigurationUpdateType {
    Insert = 1,
    Replace = 2,
    InsertOrReplace = 3,
    Delete = 4,
...
export declare const _enumerationConfigurationUpdateType: Enum;
export interface ConfigurationUpdateTargetTypeOptions {
    path?: UAString;
    updateType?: ConfigurationUpdateType;
}
export declare class ConfigurationUpdateTargetType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    path: UAString;
    updateType: ConfigurationUpdateType;
    constructor(options?: ConfigurationUpdateTargetTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    setUpdateType(value: any): ConfigurationUpdateType;
    get schema(): IStructuredTypeSchema;
}
...
export interface SpanContextDataTypeOptions {
    traceId?: Guid;
    spanId?: UInt64;
}
export declare class SpanContextDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    traceId: Guid;
    spanId: UInt64;
    constructor(options?: SpanContextDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface TraceContextDataTypeOptions extends SpanContextDataTypeOptions {
    parentSpanId?: UInt64;
    parentIdentifier?: UAString;
}
export declare class TraceContextDataType extends SpanContextDataType {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    parentSpanId: UInt64;
    parentIdentifier: UAString;
    constructor(options?: TraceContextDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface NameValuePairOptions {
    name?: UAString;
    value?: (VariantLike | null);
}
export declare class NameValuePair extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    name: UAString;
    value: Variant;
    constructor(options?: NameValuePairOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface LogRecordOptions {
    time?: DateTime;
    severity?: UInt16;
    eventType?: (NodeIdLike | null);
    sourceNode?: (NodeIdLike | null);
    sourceName?: UAString;
    message?: (LocalizedTextLike | null);
    traceContext?: TraceContextDataTypeOptions;
    additionalData?: NameValuePairOptions[] | null;
}
export declare class LogRecord extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    additionalData: NameValuePair[] | null;
    constructor(options?: LogRecordOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
export interface LogRecordsDataTypeOptions {
    logRecordArray?: LogRecordOptions[] | null;
}
export declare class LogRecordsDataType extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    static encodingDefaultXml: ExpandedNodeId;
    static encodingDefaultJson: ExpandedNodeId;
    logRecordArray: LogRecord[] | null;
    constructor(options?: LogRecordsDataTypeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
...
export interface NumberRangeOptions {
    low?: (VariantLike | null);
    high?: (VariantLike | null);
}
export declare class NumberRange extends ExtensionObject {
    static get schema(): IStructuredTypeSchema;
    static possibleFields: string[];
    static dataTypeNodeId: ExpandedNodeId;
    static encodingDefaultBinary: ExpandedNodeId;
    ...
    low: Variant;
    high: Variant;
    constructor(options?: NumberRangeOptions | null);
    encode(stream: OutputBinaryStream): void;
    decode(stream: BinaryStream): void;
    get schema(): IStructuredTypeSchema;
}
