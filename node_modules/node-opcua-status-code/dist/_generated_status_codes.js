...
class StatusCodes {
    ...
    static UncertainOverRange = new opcua_status_code_1.ConstantStatusCode({
        name: "UncertainOverRange",
        value: 0x40f20000,
        description: "The value is over the allowed range."
    });
    /** The value is under the allowed range. */
    static UncertainUnderRange = new opcua_status_code_1.ConstantStatusCode({
    ...
    static BadSemaphoreFileMissing = new opcua_status_code_1.ConstantStatusCode({
    ...
    static BadTransactionFailed = new opcua_status_code_1.ConstantStatusCode({
